...
<!-- Typing SVG: see awesome-github-profile-readme for setup :contentReference[oaicite:0]{index=0} -->
...
<!-- Shields & visitor badge: docs and examples :contentReference[oaicite:1]{index=1} -->
...
<!-- Table driven by recruiters’ scanning patterns :contentReference[oaicite:2]{index=2} -->
...
<!-- Replace with real repo names & add shields-io CI badges -->
...
<!-- Stats card action: github-readme-stats :contentReference[oaicite:3]{index=3} -->
